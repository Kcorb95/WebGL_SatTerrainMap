...
function doneReading(callback) {
    ...
    DEMObj.profiles.splice(256, DEMObj.ncols);
    DEMObj.profiles.forEach(function (prof) {
        prof.points.splice(256, DEMObj.nrows);
    });
    ...
    DEMObj.ncols = DEMObj.points.length;
    DEMObj.nrows = DEMObj.points[0].length;
